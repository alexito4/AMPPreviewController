...
#define COCOAPODS_POD_AVAILABLE_AMPPreviewController
#define COCOAPODS_VERSION_MAJOR_AMPPreviewController 0
#define COCOAPODS_VERSION_MINOR_AMPPreviewController 1
#define COCOAPODS_VERSION_PATCH_AMPPreviewController 0
